...
;; Time-stamp: <2024-05-05 15:19:55 lolh-mbp-16>
...
(ert-deftest extract-t-rx-docket-cause ()
  (let ((d0 " -- .pdf")
    ...
    (should (eq 0 (string-match *lolh/docket-date-name-rx* d0)))
    (should (null (match-string 1 d0)))
    (should (eq 0 (string-match *lolh/docket-date-name-rx* d1)))
    (should (string= "02)" (match-string 1 d1)))
    (should (eq 0 (string-match *lolh/docket-date-name-rx* d2)))
    (should (string= "02*)" (match-string 1 d2)))
    (should (eq nil (string-match *lolh/docket-date-name-rx* d3)))
    (should (eq 0 (string-match *lolh/docket-date-name-rx* d4)))
    (should (string= d4 (match-string 0 d4)))

    (should (eq 0 (string-match *lolh/docket-date-name-rx* e1)))
    (should (string= "02*)" (match-string 1 e1)))
    (should (eq 0 (string-match *lolh/docket-date-name-rx* e2)))
    (should (string= "02)" (match-string 1 e2)))
    (should (eq 0 (string-match *lolh/docket-date-name-rx* e3)))
...
(ert-deftest extract-t-rx-names ()
  (let ((g0 "LAST,First.pdf")
    ...
    (should (eq 0 (string-match *lolh/docket-date-name-rx* g4)))
...
(ert-deftest extract-t-rx-body ()
  (let ((h0 "02) -- .pdf")
    ...
    (should (eq 0 (string-match *lolh/docket-date-name-rx* h0)))
    (should (string-empty-p (match-string 8 h0)))
    (should (eq 0 (string-match *lolh/docket-date-name-rx* h1)))
    (should (string= "Some Document Name" (match-string 8 h1)))
    (should (eq 0 (string-match *lolh/docket-date-name-rx* h2)))
    (should (string= "Some Document Name" (match-string 8 h2)))
    (should (eq 0 (string-match *lolh/docket-date-name-rx* h3)))
    (should (string= "Some Document Name" (match-string 8 h3)))
    (should (eq 0 (string-match *lolh/docket-date-name-rx* h4)))
    (should (string= "Summons->2024-05-04" (match-string 8 h4)))
    (should (eq 0 (string-match *lolh/docket-date-name-rx* h5)))
    (should (null (match-string 8 h5)))
    (should (eq 0 (string-match *lolh/docket-date-name-rx* h6)))
...
(ert-deftest extract-t-rx-all ()
  (let ((x1 "02*) 24-2-09999-06 [2024-05-04] LASTA,Firsta-LASTB,Firstb -- Summons->2024-05-04.pdf"))
    (should (eq 0 (string-match *lolh/docket-date-name-rx* x1)))
...
(ert-deftest extract-t-rx-some ()
  (let ((y1 "02*) [2024-05-04] -- Complaint UD (30-DAY).PDF"))
    (should (eq 0 (string-match *lolh/docket-date-name-rx* y1)))
